...
start_editor="export DISPLAY=$display;export REMOTE_PATH=$remote_folder;export AUTO=$autosave;export AUTO_INT=$autosave_interval;/bin/sh $start_day_script_path;"
end_editor="export DISPLAY=$display;export REMOTE_PATH=$remote_folder;export EDITOR_NAME=$text_editor_name;export AUTO=$autosave;export AUTO_INT=$autosave_interval;/bin/sh $end_day_script_path;"
